...
const useStyles = {
    cardcolor: { border: "1px solid #E4E4E4", "box-shadow": "none", cursor: "pointer", height: "283px", "border-radius": "2px", width: "414px", "margin-left": "20px", "margin-top": "20px","padding-top":"50px" },
    togglecardcolor: { "box-shadow": "0px 4px 20px rgba(216, 175, 40, 0.28)", "border": "1px solid #ebd79c", cursor: "pointer", height: "283px", width: "414px", "margin-left": "20px","margin-top": "20px","padding-top":"50px" },
  ...
  cardHeading:{'font-family': 'Open Sans', 'font-style': 'normal', 'font-weight': '600', 'font-size': '14px', 'line-height': '19px', 'text-align': 'center', color: '#3D4A52'}
};
export default function ConfigureConnectorCard(props) {
      ...
      <CardContent>
        <Row>
          <Col xs={12} sm={12} md={12} lg={12}>
           <span style={useStyles.cardHeading}>{screenlabels.connector.configure_connector}</span>
          </Col>
        </Row>
        <Row>
        ...
        <Row>
          ...
          <span style={useStyles.cardtext}>{screenlabels.connector.configure_connector_text}</span>
          </Col>
          {/*
          <Col xs={12} sm={12} md={12} lg={12}>
