...
export default function ViewMetaDatasetDetails(props) {
  ...
  const deleteDataset = () => {
    ...
    HTTPService('DELETE', UrlConstant.base_url + UrlConstant.datasetview + id + '/', "", false, true)
      .then((response) => {
        setLoader(false);
  ...
  return (<>
    ...
    {isDeleteSuccess ?
      <Success
        ...
        route={"datahub/participants"} imagename={'success'} btntext={"ok"}
                ...
                <Col style={{ maxWidth: "400px" }}  >
                  ...
                  <Row >
                    ...
                    <Col>
                      ...
                      <Row className='details'>{orgdetail?.address?.address}</Row>
                      <Row className='details'>{orgdetail?.address?.pincode}</Row>
                    </Col>
                  </Row>
                </Col>
                <Col style={{ border: "0.5px solid", maxWidth: "0px", padding: "0px", margin: "0px 50px" }}>
                </Col>
                <Col style={{ maxWidth: "400px" }} >
                  <Row style={{ textAlign: "left", marginBottom: "20px" }}>
