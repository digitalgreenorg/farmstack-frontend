const CONFIG = {
  logo: {
    ...
    secondary_logo_link: require("../../../../Assets/Img/eadp/StaticLogo/primary_logo.png"), // if secondary logo is required then the path of the logo should be provided here
