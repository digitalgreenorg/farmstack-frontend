...
const AdminCategorySetupAndEdit = () => {
  ...
  const [listOfSubCategoriesForSelected, setListForSubCatForSelected] =
    useState([]);
  ...
  const categoryCreator = (value, index) => {
    ...
    localStorage.setItem(
      "categories",
      JSON.stringify([...ListOfMainCategory, obj])
    );
  };
  ...
  const generateSubCatList = (e) => {
    ...
    let cat = ListOfMainCategory.filter(
  ...
  const deleteSubCat = (value, parent) => {
    ...
    for (let i = 0; i < newArr.length; i++) {
      if (newArr[i].category == parent) {
        let newArrChildren = newArr[i].children.filter(
    ...
    <>
      <Container id="categories-main-container">
        ...
        <Row style={{ border: "1px solid red" }}>
          <Col lg={6} sm={12}>
            <TreeViewComponent
              data={ListOfMainCategory}
              setData={setListMainCategory}
            />
          </Col>
        </Row>
        <Row>
          <Col lg={3} sm={12}>
            ...
            <PopupBox
              ListOfMainCategory={ListOfMainCategory}
              setListMainCategory={categoryCreator}
              boxType={"category"}
              open={open}
              handleClose={handleClose}
              input={inputForMainCategory}
              setInput={setInputForMainCategory}
            />
          </Col>
          <Col lg={3} sm={12}>
            ...
            <Deletecategories
              ...
              boxType={"subcategory"}
              open={openCatForDel}
              handleClose={handleClickDeleCatClose}
              input={inputForSubCategory}
              setInput={setInputForSubCategory}
              handler={handleChangeMainCategory}
              inputLabel={"Main categories"}
              value={mainCategories}
              data={ListOfMainCategory}
              helperText={"Please select anyone category"}
              setListSubCategory={subCategoryCreator}
        ...
        <Row>
          <Col lg={3} sm={12}>
            ...
            <PopupBoxForSubCat
              boxType={"subcategory"}
              open={openSubCat}
              handleClose={handleCloseSubCategoryPopup}
              input={inputForSubCategory}
              setInput={setInputForSubCategory}
              handler={handleChangeMainCategory}
              inputLabel={"Main categories"}
          ...
          <Col lg={3} sm={12}>
            ...
            <DeleteSubCat
              sub_value={selectedSubCat}
              deleteSubCat={deleteSubCat}
              listOfSubCategoriesForSelected={listOfSubCategoriesForSelected}
              action={deleteSubCat}
              setIsRename={setIsRename}
              isRename={isRename}
              boxType={"subcategory"}
              open={openSubCatForDel}
              handleClose={handleClickDeleSUbCatClose}
              input={inputForSubCategory}
              setInput={setInputForSubCategory}
              handler={generateSubCatList}
              sub_cat_handler={handleChangeSubCat}
              inputLabel={"Main categories"}
              value={mainCategories}
              data={ListOfMainCategory}
              helperText={"Please select anyone category"}
