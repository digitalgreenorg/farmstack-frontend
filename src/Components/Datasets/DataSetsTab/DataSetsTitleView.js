    ...
    return (
        <div className='d-flex justify-content-between'>
            ...
            <div className='d-flex align-items-center mt-50 mb-20'>
                <div className='d-flex mr-30 cursor-pointer' onClick={() => setIsGrid(false)}>
                    <img className='mr-7' src={require(`../../../Assets/Img/${isGrid ? 'list_view_gray.svg' : 'list_view_green.svg'}`)} />
                    <Typography sx={{
                        color: !isGrid ? '#00AB55' : '#3D4A52'
                    }}>List view</Typography>
                </div>
                <div className='d-flex cursor-pointer' onClick={() => setIsGrid(true)}>
                    <img className='mr-7' src={require(`../../../Assets/Img/${isGrid ? 'grid_view_green.svg' : 'grid_view_gray.svg'}`)} />
                    <Typography sx={{
                        color: isGrid ? '#00AB55' : '#3D4A52'
