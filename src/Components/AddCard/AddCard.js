...
const useStyles = {
  btncolor:{border: "1px solid #E4E4E4","box-shadow": "none",cursor:"pointer", "border-radius": "2px", 'height': "240px", 'width': '346px'}, 
  togglebtncolor:{"box-shadow": "0px 4px 20px rgba(216, 175, 40, 0.28)","border": "2px solid #ebd79c",cursor:"pointer", 'height': '240px', 'width': '346px'}, 
