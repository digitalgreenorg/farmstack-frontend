...
export default function LocalMachineUploadDataset(props) {
  ...
  const handleAddDatasetFile = (currentFileList) => {
    ...
    console.log(
      "currentFileList before upload dataset api call",
      currentFileList
    );
            ...
            if (errorKeys.length > 0) {
              ...
              for (var i = 0; i < errorKeys.length; i++) {
                ...
                switch (errorKeys[i].trim()) {
                  ...
                  default:
                    setMessageForSnackBar(
                      "Some error occurred during uploading!"
                    );
                    handleClick();
                    break;
                }
    ...
    HTTPService(
      ...
      .then((response) => {
        ...
        if (response.status === 204) {
          console.log("file deleted");
          var filteredArray = uploadFile.filter(
          ...
          <Row style={{ height: "236px", marginBottom: "50px" }}>
            ...
            <Col xs={12} sm={12} md={12} lg={6}>
              <ConnectionProgressGif
                ...
                sizeismore={sizeismore}
                setSizeIsMore={setSizeIsMore}
              />
            </Col>
          </Row>
          {/* {uploadFile ? 
