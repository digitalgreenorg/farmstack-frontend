                ...
                {isSuccess ? <>
                    ...
                    <Row>
                        ...
                        <Col xs={12} sm={12} md={6} lg={6} >
                            ...
                            <Button onClick={() => history.push('/datahub/participants/edit/' + id)} variant="outlined" className="editbtn" id='editparticipantbtn'>
                                Edit participant
                         </Button>
                        </Col>
                    </Row>
                    <Row style={useStyles.marginrowtop8px}>
                        ...
                        <Col xs={12} sm={12} md={6} lg={6} >
                            <Button variant="outlined" onClick={() => { setisDelete(true); setisSuccess(false); setisDeleteSuccess(false) }} className="cancelbtn" id="deletepartcipantbtn">
                                Delete participant
                </Button>
