...
export default function GuestUserLegalPage({legalData}) {
  ...
  return (
    <Box sx={{fontFamily:"Open Sans", fontStyle:"normal", boxSizing:"border-box"}}>
    ...
    <Box sx={{ width: '1300px', typography: 'body',margin:"auto", padding:"0"  }}>
      <TabContext  value={value}>
       ...
       <div style={{ marginTop:"50px"}}>
        {legalData.map((eachLegalPolicy, index)=>(<TabPanel sx={{padding:"0", margin:"0"}} value={index+1} >
            <div style={{display:"flex", flexDirection:"column",alignItems:"left", textAlign:"left",fontFamily:"Open Sans", fontStyle:"normal", marginLeft:"110px"}}>

            <div style={{display:"flex", justifyContent:"space-between"}}>
                <div style={{fontSize:"20px", fontWeight:"700", color:"#3D4A52"}}> {eachLegalPolicy.title}</div>
                
                <div style={{display:"flex"}}>

                <a target="blank" href={UrlConstant.base_url +  eachLegalPolicy.download} style={{display:"flex", alignItems:"center", justifyContent:"space-between", fontSize:"14px", fontWeight:"400",color:"#3491EE",marginRight:"34px"}}> <img style={{width:"22px", height:"15px", marginRight:"11px"}} src={viewbuttonsvgicon} alt={eachLegalPolicy.title  }/> <spna>View document</spna> </a>
                <a target="blank" href={UrlConstant.base_url +  eachLegalPolicy.download} style={{display:"flex", alignItems:"center", justifyContent:"space-between", fontSize:"14px", fontWeight:"400",color:"#3491EE"}}> <img style={{width:"16px", height:"16px", marginRight:"14px"}} src={downloadIcon} alt={eachLegalPolicy.title  }/> <spna>Download document</spna> </a>
                </div>
