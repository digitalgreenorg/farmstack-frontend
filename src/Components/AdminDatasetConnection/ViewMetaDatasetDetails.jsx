                ...
                <>
                  ...
                  <Row className="main_heading_row">
                    <Col
                      lg={3}
                      sm={6}
                      style={{ marginLeft: "99px", marginTop: "50px" }}
                    >
                  ...
                  <Row>
                    ...
                    >
                      <span>
                        Agricultural Practices Video Dissemintion Data
                      </span>
                    </Col>
                  </Row>
                  ...
                  >
                    <span className="mainheading">
                      {userType !== "guest" ? "Download Data" : "Sample Data"}
                    </span>
                  </Row>
                  <Row
                    style={{
        ...
        //    fileTypes = ["XLS" && "xlsx" && "CSV" ] ?  */}
                        ...
                        {fileData.map((downloadfile) => (
                          <Row
                            ...
                            onClick={() =>
                              userType != "guest"
                                ? downloadAttachment(
                                    UrlConstant.base_url + downloadfile.file,
                  ...
                  <Row style={{ "margin-left": "20px" }}>
                    <Col style={{ marginLeft: "30px", "margin-top": "50px" }}>
                      <Row className="secondmainheading">
                        <Col style={{ "margin-left": "-130px" }}>
                          ORGANISATION
                        </Col>
                      </Row>
                      <Col
                        className="thirdmainheading"
                        style={{ marginLeft: "-17px", "margin-top": "30px" }}
                      >
                        <Col>
                          <Avatar
                            alt="Remy Sharp"
                        ...
                        <Col
                          style={{ "margin-left": "90px", marginTop: "-30px" }}
                        >
