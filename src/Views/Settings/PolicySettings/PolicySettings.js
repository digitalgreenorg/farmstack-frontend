...
export default function PolicySettings() {
  ...
  const useStyles = {
    ...
    headingtext: { "font-weight": "700", "font-size": "20px", "margin-left": "15px", "font-family:" :"Open Sans","margin-top":"10px","margin-bottom":"10px"},
    uploadMessage: {"font-family:" :"Open Sans", "font-style":"normal","font-weight":"400"},
    ...
    <div style={useStyles.tabmargin}>
      <form noValidate autoComplete="off" onSubmit={handlePoliciesSubmit}>
        ...
        <Row style={useStyles.marginrow}>
            ...
            { editorGovLawValue.getEditorState().getCurrentContent().hasText() && (govLawFile || govLawFileUrl) &&
              editorWarrantiesValue.getEditorState().getCurrentContent().hasText() && (warrantiesFile || warrantyFileUrl) &&
              editorLiabalityValue.getEditorState().getCurrentContent().hasText() && (liabalityFile || liabilityFileUrl) &&
              editorPrivacyValue.getEditorState().getCurrentContent().hasText() && (privacyFile || privacyFileUrl) &&
              editorTermValue.getEditorState().getCurrentContent().hasText() && (termFile || termsFileUrl)
              ?
            (<Button
                  variant="contained"
