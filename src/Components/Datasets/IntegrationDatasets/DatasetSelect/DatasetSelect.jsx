        ...
        <Container className='dataset_selector_in_integration'>
            <Row>
                ...
                <Col lg={4} sm={12} sx={12}>
                    {/* <span className={styles.add_dataset_btn_dis} onClick={() => handleClickSelectDataset("dataset")}>+ Add datasets</span> */}
            ...
            <Row >
                {noOfDatasetSelector.map((eachDatasetName, i) => {
                    return <Col key={i} lg={6} sm={12} sx={12} className={styles.each_select_for_dataset}>
            ...
            <Row>
                {noOfFileSelector.map((eachFileName, i) => {
                    return <Col key={i} lg={6} sm={12} sx={12} className={styles.each_select_for_dataset}>
                        <FormControl variant="standard" fullWidth>
