    ...
    <>
      <Row style={useStyles.marginrowtop}>
        <Col xs={12} sm={12} md={12} lg={12} style={useStyles.left}>
          ...
          >
            ...
            />
            &nbsp;&nbsp;&nbsp;
            <span className="backlabel">{screenlabels.common.back}</span>
          </div>
        </Col>
      </Row>
      <hr
      ...
      <Row style={useStyles.marginrowtop}>
        <Col xs={12} sm={12} md={12} lg={12} style={useStyles.left}>
          <span className="mainheading">
            {props.coSteward
              ? screenlabels.viewCoSteward.first_heading
      ...
      <Row style={useStyles.marginrowtop}>
        <Col xs={12} sm={12} md={4} lg={4} style={{ textAlign: "left" }}>
          ...
          <Tooltip
            placement="bottom-start"
            TransitionComponent={Zoom}
            title={props.organisationaddress}
          >
            <span className="thirdmainheading d-inline-block text-truncate width300px_mt5px">
      ...
      <Row style={useStyles.marginrowtop}>
        <Col xs={12} sm={12} md={12} lg={12} style={useStyles.left}>
          <span className="mainheading">
            {props.coSteward
              ? screenlabels.viewCoSteward.second_heading
