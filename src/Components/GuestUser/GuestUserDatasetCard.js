        ...
        <Card className={props.margingtop} style={!isshowbutton ? useStyles.cardcolor : useStyles.togglecardcolor} onMouseEnter={() => setisshowbutton(true)} onMouseLeave={() => setisshowbutton(false)}>
            ...
            <CardContent>
                ...
                <Row>
                    ...
                    <Col className="fontweight600andfontsize14pxandcolor3D4A52 supportcardsecondcolumn" style={{textAlign: 'left'}}>
                ...
                <Row className="supportcardmargintop">
                    ...
                    <Col style={{"font-size":"14px","font-weight":"400","text-transform": "capitalize", textAlign: 'left' }} className="fontweight400andfontsize14pxandcolor3D4A52 supportcardsecondcolumn">
                ...
                <Row className="supportcardmargintop">
                    ...
                    <Col style={{"padding-right":"4px",color: "#3D4A52", "text-transform": "capitalize", textAlign: 'left' }} className="fontweight400andfontsize14pxandcolor3D4A52 supportcardsecondcolumndata">
                        {props.cropDetail}
                    </Col>
                    </Tooltip>
                </Row>
