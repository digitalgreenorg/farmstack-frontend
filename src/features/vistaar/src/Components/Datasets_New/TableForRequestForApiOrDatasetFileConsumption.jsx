...
const TableForRequestForApiOrDatasetFileConsumption = (props) => {
  ...
  useEffect(() => {
    let show = true;
    console.log("use Effect calling", data);
        ...
        {data?.length > 0 && (
          <Row className="mt-20">
            <Col lg={6} md={12} sm={12}>
              ...
              >
                {" "}
                View the list of access requests for your FLEW Registry.{" "}
              </Typography>
            </Col>
...
export default TableForRequestForApiOrDatasetFileConsumption;
