...
import { MuiThemeProvider, Zoom } from "@mui/material";
        ...
        <Col style={{ maxWidth: "346px", textAlign: "left" }}>
          ...
          >
            ...
            <Tooltip
              ...
              title={datahubUserDetails.admin_name}
            >
          ...
          >
            ...
            <Tooltip
              placement="bottom-start"
              TransitionComponent={Zoom}
              title={datahubUserDetails.org_name}
            >
              <div className={styles.guestUserDatahubAdminDetails}>
                {" "}
          ...
          >
            ...
            <Tooltip
              placement="bottom-start"
              TransitionComponent={Zoom}
              title={datahubUserDetails.address}
            >
              <div className={styles.guestUserDatahubAdminDetails}>
          ...
          >
            ...
            <Tooltip
              placement="bottom-start"
              TransitionComponent={Zoom}
              title={datahubUserDetails.phone_number}
            >
              <div className={styles.guestUserDatahubAdminDetails}>
        ...
        <Col style={{ maxWidth: "340px", textAlign: "left" }}>
          ...
          >
            ...
            <Tooltip
              placement="bottom-start"
              TransitionComponent={Zoom}
              title={datahubUserDetails.admin_email}
            >
              <div className={styles.guestUserDatahubAdminDetails}>
          ...
          >
            ...
            <Tooltip
              placement="bottom-start"
              TransitionComponent={Zoom}
              title={datahubUserDetails.country}
            >
              <div className={styles.guestUserDatahubAdminDetails}>
          ...
          >
            ...
            <Tooltip
              placement="bottom-start"
              TransitionComponent={Zoom}
              title={datahubUserDetails.website}
            >
              <div
                className={styles.guestUserDatahubAdminDetails}
                style={{ color: "#3491EE", cursor: "pointer" }}
        ...
        <Col style={{ maxWidth: "174px", textAlign: "left" }}>
          ...
          >
            ...
            <Tooltip
              placement="bottom-start"
              TransitionComponent={Zoom}
              title={datahubUserDetails.admin_phone}
            >
              <div className={styles.guestUserDatahubAdminDetails}>
          ...
          >
            ...
            <Tooltip
              placement="bottom-start"
              TransitionComponent={Zoom}
              title={datahubUserDetails.admin_pin_code}
            >
              <div className={styles.guestUserDatahubAdminDetails}>
          ...
          >
            ...
            <Tooltip
              placement="bottom-start"
              TransitionComponent={Zoom}
              title={datahubUserDetails.email_id}
            >
              <div className={styles.guestUserDatahubAdminDetails}>
        ...
        >
          ...
          >
            <TextField
              ...
              error={
                emailErrorMessage || (emailError && useDetails.email.length > 0)
                  ? true
                  : false
              }
