    ...
    <>
      ...
      {screenView.isChangeRequestSuccess ? (
        <Success
          ...
          imageText={"Disabled"}
          msg={"Change Request Sent."}></Success>
      ) : (
        <></>
      )}
      {screenView.isDataSetView ? (
        <>
          <ViewDataSet
            ...
            rowdata={viewdata}
            tabelkeys={tablekeys}></ViewDataSet>
          {isAdminView ? (
            <>
              <Row>
      ...
      {screenView.isDisableSuccess ? (
        <Success
          ...
          imageText={"Disabled"}
          msg={"You diabled a dataset."}></Success>
      ) : (
        <></>
      )}
      {screenView.isEnable ? (
      ...
      {screenView.isEnableSuccess ? (
        <Success
          ...
          imageText={"Enabled"}
          msg={"You enabled a dataset."}></Success>
      ) : (
        <></>
      )}
      ...
      {screenView.isApproveSuccess ? (
        <Success
          ...
          heading={"Approve Dataset"}
          imageText={"Approved"}
          msg={"You approved a dataset."}></Success>
      ) : (
        <></>
      )}
      ...
      {screenView.isDisapproveSuccess ? (
        <Success
          ...
          msg={"You disapproved a dataset."}></Success>
      ) : (
        <></>
      )}
      {screenView.isDelete ? (
      ...
      {screenView.isDeleSuccess ? (
        <Success
          ...
          imageText={"Deleted!"}
          msg={"You deleted a dataset."}></Success>
      ) : (
        <></>
      )}
